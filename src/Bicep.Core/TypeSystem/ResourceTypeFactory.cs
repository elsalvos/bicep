...
namespace Bicep.Core.TypeSystem
{
    public class ResourceTypeFactory
    {
        ...
        private TypeReference GetTypeReference(Types.Concrete.ITypeReference input)
            => new TypeReference(() => GetTypeSymbol(input.Type));
        ...
        private TypeSymbol ToTypeSymbol(Types.Concrete.TypeBase typeBase)
        {
            switch (typeBase)
            {
                ...
                case Types.Concrete.DiscriminatedObjectType discriminatedObjectType:
                {
                    ...
                    var elementReferences = elements.Select(kvp => new TypeReference(() => ToCombinedType(discriminatedObjectType.BaseProperties, kvp.Key, kvp.Value)));
